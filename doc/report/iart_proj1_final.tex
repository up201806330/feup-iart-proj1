...
\pgfplotstableread[col sep=comma]{#2}\datatable
    ...
    \addplot [draw=none, fill=gray!40, stack plots=y, area legend, #1] table [
        x={#3},
        y expr=\thisrow{#5}-\thisrow{#4}
    ] {\datatable} \closedcycle;

    % Reset stack using invisible plot
    \addplot [forget plot, stack plots=y,draw=none] table [x={#3}, y expr=-\thisrow{#5}] {\datatable};
}
...
\begin{frame}
  ...
  \begin{figure}
    \begin{tikzpicture}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[black  , opacity=0.15]{../../analysis/further-analysis/bfs-processed.csv                  }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[blue   , opacity=0.15]{../../analysis/further-analysis/dfs-greedy-admissible-processed.csv}{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[red    , opacity=0.15]{../../analysis/further-analysis/greedy-admissible-processed.csv    }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[green  , opacity=0.15]{../../analysis/further-analysis/astar-admissible-processed.csv     }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      % \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[cyan   , opacity=0.15]{../../analysis/further-analysis/dfs-greedy-fh-processed.csv        }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      % \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[magenta, opacity=0.15]{../../analysis/further-analysis/greedy-fh-processed.csv            }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      % \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/further-analysis/astar-fh-processed.csv             }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,
        ...
        % \addplot [cyan   ,mark=*,thick] table [col sep=comma,x=nTubes,y=tmsMean]{../../analysis/further-analysis/dfs-greedy-fh-processed.csv};
        % \addplot [magenta,mark=*,thick] table [col sep=comma,x=nTubes,y=tmsMean]{../../analysis/further-analysis/greedy-fh-processed.csv};
        % \addplot [yellow ,mark=*,thick] table [col sep=comma,x=nTubes,y=tmsMean]{../../analysis/further-analysis/astar-fh-processed.csv};
...
%   \begin{figure}
%     \begin{tikzpicture}
%       \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[black  , opacity=0.15]{../../analysis/further-analysis/bfs-processed.csv                  }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
%       \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[blue   , opacity=0.15]{../../analysis/further-analysis/dfs-greedy-admissible-processed.csv}{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
%       \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[red    , opacity=0.15]{../../analysis/further-analysis/greedy-admissible-processed.csv    }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
%       \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[green  , opacity=0.15]{../../analysis/further-analysis/astar-admissible-processed.csv     }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
%       \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[cyan   , opacity=0.15]{../../analysis/further-analysis/dfs-greedy-fh-processed.csv        }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
%       \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[magenta, opacity=0.15]{../../analysis/further-analysis/greedy-fh-processed.csv            }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
%       \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/further-analysis/astar-fh-processed.csv             }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
%       \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-3,ymax=1e4,width=12cm,height=7.2cm
...
%         \addplot [cyan   ,mark=*,thick] table [col sep=comma,x=nTubes,y=memMBMean]{../../analysis/further-analysis/dfs-greedy-fh-processed.csv};
%         \addplot [magenta,mark=*,thick] table [col sep=comma,x=nTubes,y=memMBMean]{../../analysis/further-analysis/greedy-fh-processed.csv};
%         \addplot [yellow ,mark=*,thick] table [col sep=comma,x=nTubes,y=memMBMean]{../../analysis/further-analysis/astar-fh-processed.csv};
