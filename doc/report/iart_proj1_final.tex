...
\begin{frame}
  ...
  \begin{figure}
    \begin{tikzpicture}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-1,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[black  , opacity=0.15]{../../analysis/further-analysis/bfs-processed.csv                  }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-1,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[blue   , opacity=0.15]{../../analysis/further-analysis/dfs-greedy-admissible-processed.csv}{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-1,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[red    , opacity=0.15]{../../analysis/further-analysis/greedy-admissible-processed.csv    }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=9.3,ymin=1e-1,ymax=1e4,width=12cm,height=7.2cm,hide axis]\errorband[green  , opacity=0.15]{../../analysis/further-analysis/astar-admissible-processed.csv     }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
