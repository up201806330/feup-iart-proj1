...
\begin{frame}
  ...
  \begin{itemize}
    \item \textbf{Admissible heuristic} | Uses two factors to estimate the cost to reach the goal state: let $f(t)$ be the number of contiguous same-color ball at the bottom of tube $t$. We add $h_t-f(t)$ to the heuristic to account for balls we will have to move. Then we account for the cost of moving all balls of the same color to the same tube.
...
\begin{frame}
  \begin{figure}
    \begin{tikzpicture}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-2,ymax=1e5,width=11cm,height=7.5cm,hide axis]\errorband[black  , opacity=0.15]{../../analysis/large/bfs-processed.csv                     }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-2,ymax=1e5,width=11cm,height=7.5cm,hide axis]\errorband[blue   , opacity=0.15]{../../analysis/large/dfs-greedy-admissible-processed.csv   }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-2,ymax=1e5,width=11cm,height=7.5cm,hide axis]\errorband[red    , opacity=0.15]{../../analysis/large/greedy-admissible-processed.csv       }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-2,ymax=1e5,width=11cm,height=7.5cm,hide axis]\errorband[green  , opacity=0.15]{../../analysis/large/astar-admissible-processed.csv        }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-2,ymax=1e5,width=11cm,height=7.5cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/large/astar-nonadmissible-processed.csv     }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-2,ymax=1e5,width=11cm,height=7.5cm,
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabular}{c c c}
      \begin{tikzpicture}
        \begin{semilogyaxis}[xmin=0.7,xmax=6.3,ymin=5e-3,ymax=5e4,width=5.3cm,height=5.8cm,
          grid=both,
          xtick distance=1,
          ytick distance=10,
          xticklabels={},
      ...
      \end{minipage} \hspace{0.2em} &
      \begin{tikzpicture}
        \begin{semilogyaxis}[xmin=0.7,xmax=6.3,ymin=5e-3,ymax=3e1,width=5.3cm,height=5.8cm,
          grid=both,
          xtick distance=1,
          ytick distance=10,
          xticklabels={},
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabular}{c c c}
      \begin{tikzpicture}
        \begin{semilogyaxis}[xmin=0.7,xmax=6.3,ymin=7e-2,ymax=5e3,width=5.3cm,height=5.8cm,
          grid=both,
          xtick distance=1,
          ytick distance=10,
          xticklabels={},
