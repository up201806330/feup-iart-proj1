...
\begin{frame}
  ...
  Seed is 0, and time measurements are averaged over 10 executions.

  \textbf{Optimality}

  Defined as quotient of optimal solution by obtained solution. $1$ means optimal, $<1$ means sub-optimal.
  ...
  \begin{figure}
    ...
    \begin{tabular}{@{} r | r | r || l | l | l | l | l | l | l | l | l @{}}
      & & & \multicolumn{9}{c}{\textbf{Optimality}} \\ \cline{4-12}
      ...
      \rotatebox[origin=c]{90}{\textbf{ID}} &
