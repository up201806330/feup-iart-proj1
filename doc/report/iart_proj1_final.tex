...
\begin{frame}
  \begin{figure}
    \begin{tikzpicture}
      ...
      \begin{axis}[xmin=1.7,xmax=9.3,ymin=0,ymax=1,width=11cm,height=7.5cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/further-analysis/astar-nonadmissible-processed.csv     }{nTubes}{nMovesMin}{nMovesMax}\end{axis}
      \begin{axis}[xmin=1.7,xmax=9.3,ymin=0,ymax=1,width=11cm,height=7.5cm
        ...
        \addplot [yellow ,mark=*,thick] table [col sep=comma,x=nTubes,y=nMovesMean]{../../analysis/further-analysis/astar-nonadmissible-processed.csv};
...
\begin{frame}
  \begin{figure}
    \begin{tikzpicture}
      ...
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=2e-3,ymax=7e4,width=11cm,height=7.5cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/further-analysis/astar-nonadmissible-processed.csv     }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=2e-3,ymax=7e4,width=11cm,height=7.5cm,
        ...
        \addplot [yellow ,mark=*,thick] table [col sep=comma,x=nTubes,y=tmsMean]{../../analysis/further-analysis/astar-nonadmissible-processed.csv};
...
\begin{frame}
  \begin{figure}
    \begin{tikzpicture}
      ...
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-1,ymax=8e3,width=11cm,height=7.5cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/further-analysis/astar-nonadmissible-processed.csv     }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-1,ymax=8e3,width=11cm,height=7.5cm,
        ...
        \addplot [yellow ,mark=*,thick] table [col sep=comma,x=nTubes,y=memMBMean]{../../analysis/further-analysis/astar-nonadmissible-processed.csv};
