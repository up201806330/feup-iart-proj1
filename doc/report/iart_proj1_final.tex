...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{Non-admissible heuristic} | To easily simulate a non-admissible heuristic, we just run the admissible heuristic and multiply by a constant factor. Algorithms using a non-admissible heuristic are marked with (NA).
...
%   \begin{figure}
%     \begin{tikzpicture}
%       \begin{axis}[xmin=1.7,xmax=9.3,ymin=0,ymax=1,width=11cm,height=7.5cm,hide axis]\errorband[black  , opacity=0.15]{../../analysis/large/bfs-processed.csv                     }{nTubes}{nMovesMin}{nMovesMax}\end{axis}
%       \begin{axis}[xmin=1.7,xmax=9.3,ymin=0,ymax=1,width=11cm,height=7.5cm,hide axis]\errorband[blue   , opacity=0.15]{../../analysis/large/dfs-greedy-admissible-processed.csv   }{nTubes}{nMovesMin}{nMovesMax}\end{axis}
%       \begin{axis}[xmin=1.7,xmax=9.3,ymin=0,ymax=1,width=11cm,height=7.5cm,hide axis]\errorband[red    , opacity=0.15]{../../analysis/large/greedy-admissible-processed.csv       }{nTubes}{nMovesMin}{nMovesMax}\end{axis}
%       \begin{axis}[xmin=1.7,xmax=9.3,ymin=0,ymax=1,width=11cm,height=7.5cm,hide axis]\errorband[green  , opacity=0.15]{../../analysis/large/astar-admissible-processed.csv        }{nTubes}{nMovesMin}{nMovesMax}\end{axis}
%       \begin{axis}[xmin=1.7,xmax=9.3,ymin=0,ymax=1,width=11cm,height=7.5cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/large/astar-nonadmissible-processed.csv     }{nTubes}{nMovesMin}{nMovesMax}\end{axis}
...
%       ]
%         \addplot [black  ,mark=*,thick] table [col sep=comma,x=nTubes,y=nMovesMean]{../../analysis/large/bfs-processed.csv};
%         \addplot [blue   ,mark=*,thick] table [col sep=comma,x=nTubes,y=nMovesMean]{../../analysis/large/dfs-greedy-admissible-processed.csv};
%         \addplot [red    ,mark=*,thick] table [col sep=comma,x=nTubes,y=nMovesMean]{../../analysis/large/greedy-admissible-processed.csv};
%         \addplot [green  ,mark=*,thick] table [col sep=comma,x=nTubes,y=nMovesMean]{../../analysis/large/astar-admissible-processed.csv};
%         \addplot [yellow ,mark=*,thick] table [col sep=comma,x=nTubes,y=nMovesMean]{../../analysis/large/astar-nonadmissible-processed.csv};
...
\begin{frame}
  \begin{figure}
    \begin{tikzpicture}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=2e-3,ymax=7e4,width=11cm,height=7.5cm,hide axis]\errorband[black  , opacity=0.15]{../../analysis/large/bfs-processed.csv                     }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=2e-3,ymax=7e4,width=11cm,height=7.5cm,hide axis]\errorband[blue   , opacity=0.15]{../../analysis/large/dfs-greedy-admissible-processed.csv   }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=2e-3,ymax=7e4,width=11cm,height=7.5cm,hide axis]\errorband[red    , opacity=0.15]{../../analysis/large/greedy-admissible-processed.csv       }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=2e-3,ymax=7e4,width=11cm,height=7.5cm,hide axis]\errorband[green  , opacity=0.15]{../../analysis/large/astar-admissible-processed.csv        }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=2e-3,ymax=7e4,width=11cm,height=7.5cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/large/astar-nonadmissible-processed.csv     }{nTubes}{tmsMin}{tmsMax}\end{semilogyaxis}
...
\begin{frame}
  \begin{figure}
    \begin{tikzpicture}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-1,ymax=8e3,width=11cm,height=7.5cm,hide axis]\errorband[black  , opacity=0.15]{../../analysis/large/bfs-processed.csv                     }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-1,ymax=8e3,width=11cm,height=7.5cm,hide axis]\errorband[blue   , opacity=0.15]{../../analysis/large/dfs-greedy-admissible-processed.csv   }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-1,ymax=8e3,width=11cm,height=7.5cm,hide axis]\errorband[red    , opacity=0.15]{../../analysis/large/greedy-admissible-processed.csv       }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-1,ymax=8e3,width=11cm,height=7.5cm,hide axis]\errorband[green  , opacity=0.15]{../../analysis/large/astar-admissible-processed.csv        }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
      \begin{semilogyaxis}[xmin=1.7,xmax=15.3,ymin=1e-1,ymax=8e3,width=11cm,height=7.5cm,hide axis]\errorband[yellow , opacity=0.15]{../../analysis/large/astar-nonadmissible-processed.csv     }{nTubes}{memMBMin}{memMBMax}\end{semilogyaxis}
